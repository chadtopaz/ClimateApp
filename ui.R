...
shinyUI(
  ...
  pageWithSidebar(
    ...
    sidebarPanel(      
      helpText("Documenation: This applet downloads, processes, and visualizes data from the National Atmospheric and Oceanic Administration's Normals Daily database. Full documentation on this dataset is available at:"),
    ...
    mainPanel(
      h3('Long term averages, 1981 - 2010'),
      plotOutput("dataPlot")
    )
